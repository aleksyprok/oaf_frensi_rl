...
class TradingEnvironment(gym.Env):
    ...
    def __init__(self,
        ...
        # Alex edit
        self.observation_space = gym.spaces.Box(low=-np.inf, high=np.inf, shape=(len(self.data_source.X_train.columns),), dtype=np.float32)
    ...
    def step(self, action):
        ...
        # alex edit
        terminated = done  # This is your existing 'done' condition
        truncated = False  # Set to True if the episode is truncated due to max steps
